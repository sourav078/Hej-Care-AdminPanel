                        ...
                        <div>
                            ...
                            <form action="<?php echo e(route('portfolio.store')); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form">
                                    ...
                                    <div class="form-floating mb-3">
                                        <textarea name="description" id="summernote" class="form-control" ><?php echo e(old('description')); ?></textarea>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="link" id="txtLink" class="form-control" placeholder="Enter Link" value="<?php echo e(old('link')); ?>" />
...
<?php echo $__env->make('backend.layouts.master_v2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\codeact-laravel-cms\resources\views/backend/pages/portfolio/create.blade.php ENDPATH**/ ?>