        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-title-box">
                    <h4 class="page-title">Edit Team Form</h4>
                    <!-- breadcumbs -->
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card-box table-responsive">
                    <h4 class="header-title"><b>Edit Team : <?php echo e($team->title); ?></b></h4>
                    <div class="p20">
                        <div>
                            ...
                            <form action="<?php echo e(route('team.update', $team->id)); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form">
                                        ...
                                        <div class="tab-pane fade show active p10" id="basic-information-tab">
                                            <div class="form-row">
                                                <div class="form-group col-md-10 col-sm-12">
                                                    ...
                                                    <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title" value="<?php echo e($team->title); ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-10 col-sm-12">
                                                    <label for="designation">Designation</label>
                                                    <input type="text" class="form-control" id="designation" name="designation" placeholder="Enter Designation" value="<?php echo e($team->designation); ?>" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6 col-sm-12">
                                                    ...
                                                    <img src="<?php echo e(asset('storage/'.$team->image)); ?>" alt="Current Image" style="max-width: 200px; max-height: 200px;">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6 col-sm-12">
                                    ...
                                    <div class="save-button-form-v1">
                                        <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Save Team</button>
                                    </div>
                                </div>
                            </form>
                            <!-- main form end -->
...
<?php echo $__env->make('backend.layouts.master_v2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hej-Care_AdminPanel\resources\views/backend/pages/team/edit.blade.php ENDPATH**/ ?>