        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-title-box">
                    <h4 class="page-title">Create Team Form</h4>
                    <!-- breadcumbs -->
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card-box table-responsive">
                    <h4 class="header-title"><b>Create Team</b></h4>
                    <div class="p20">
                        <div>
                            ...
                            <form action="<?php echo e(route('team.store')); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="designation" id="txtDesignation" class="form-control" placeholder="Enter Designation" value="<?php echo e(old('designation')); ?>"/>
                                        <label for="txtTitle">Enter Designation</label>
                                    </div>
...
<?php echo $__env->make('backend.layouts.master_v2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hej-Care_AdminPanel\resources\views/backend/pages/team/create.blade.php ENDPATH**/ ?>