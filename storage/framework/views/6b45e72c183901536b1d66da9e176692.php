        ...
        <ul>
            ...
            <!-- end of user menu -->
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('team.list')): ?>
                    <li <?php if(Route::currentRouteName() == 'team.index' || Route::currentRouteName() == 'team.create'): ?> class="active has_sub" <?php else: ?> class="has_sub" <?php endif; ?>>
                        <a href="javascript:void(0);" class="waves-effect">
                            <img src="<?php echo e(asset('backend/assets_v2/images/icon/users-04.svg')); ?>" class="img-fluid">
                            <span>Team</span>
                            <span class="menu-arrow"></span>
                        ...
                        <ul class="collapse">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('team.create.form')): ?>
                                <li <?php if(Route::currentRouteName() == 'team.create'): ?> class="active" <?php endif; ?>>
                                    <a href="<?php echo e(route('team.create')); ?>">Create Team</a>
                                </li>
                            <?php endif; ?>
                            <li <?php if(Route::currentRouteName() == 'team.index'): ?> class="active" <?php endif; ?>><a href="<?php echo e(route('team.index')); ?>">Manage Team</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\Hej-Care_AdminPanel\resources\views/backend/layouts/partials/v2/left_side_bar_v2.blade.php ENDPATH**/ ?>