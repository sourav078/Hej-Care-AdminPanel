        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card-box table-responsive">
                    <h4 class="header-title"><b>Edit Service : <?php echo e($service->title); ?></b></h4>
                    <div class="p20">
                        <div>
                                        ...
                                        <div class="tab-pane fade show active p10" id="basic-information-tab">
                                            <div class="form-row">
                                                <div class="form-group col-md-10 col-sm-12">
                                                    ...
                                                    <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title" value="<?php echo e($service->title); ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-10 col-sm-12">
                                                <label for="description">Description</label>
                                                <textarea name="description" id="summernote" class="form-control" placeholder="Enter Description"><?php echo e($service->description); ?></textarea>
                                            </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6 col-sm-12">
                                                    <label for="image">Current Image</label><br>
                                                    <img src="<?php echo e(asset('storage/'.$service->image)); ?>" alt="Current Image" style="max-width: 200px; max-height: 200px;">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6 col-sm-12">
...
<?php echo $__env->make('backend.layouts.master_v2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\codeact-laravel-cms\resources\views/backend/pages/services/edit.blade.php ENDPATH**/ ?>