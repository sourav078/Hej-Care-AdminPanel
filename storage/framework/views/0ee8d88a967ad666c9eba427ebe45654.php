        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card-box table-responsive">
                    <h4 class="header-title"><b>Edit Portfolio : <?php echo e($portfolio->title); ?></b></h4>
                    <div class="p20">
                        <div>
                                        ...
                                        <div class="tab-pane fade show active p10" id="basic-information-tab">
                                            <div class="form-row">
                                                <div class="form-group col-md-10 col-sm-12">
                                                    ...
                                                    <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title" value="<?php echo e($portfolio->title); ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-10 col-sm-12">
                                                <label for="description">Description</label>
                                                <textarea name="description" id="summernote" class="form-control" placeholder="Enter Description"><?php echo $portfolio->description; ?>  </textarea>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-10 col-sm-12">
                                                    <label for="image">Current Image</label><br>
                                                    <img src="<?php echo e(asset('storage/'.$portfolio->image)); ?>" alt="Current Image" style="max-width: 200px; max-height: 200px;">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-10 col-sm-12">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-10 col-sm-12">
                                                    ...
                                                    <input type="url" class="form-control" id="link" name="link" placeholder="Enter Link" value="<?php echo e($portfolio->link); ?>" required>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('backend.layouts.master_v2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\codeact-laravel-cms\resources\views/backend/pages/portfolio/edit.blade.php ENDPATH**/ ?>